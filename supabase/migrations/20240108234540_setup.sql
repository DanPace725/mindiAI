...
AS $$
DECLARE
  project_url TEXT := 'https://uyuconaspzhfdvavuhzf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InV5dWNvbmFzcHpoZmR2YXZ1aHpmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMDk1NjczMSwiZXhwIjoyMDI2NTMyNzMxfQ.REXPYvZKlb746dN5ISVBztEFkrZV1dwLDwp2YIHVolM'; -- full access needed for http request to storage
